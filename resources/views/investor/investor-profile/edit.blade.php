                    ...
                    <div class="card">
                        <div id="sticky-wrapper" class="sticky-wrapper" style="height: 86.0625px;">
                            <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row"
                                style="width: 1390px;">
                                <h5 class="card-title mb-sm-0 me-2">investor Profile Edit Form</h5>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="POST" action="{{ route('update-investor-profile', ['id' => $data->id]) }}"  enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="investment_range" name="investment_range" value="{{ $data->investment_range }}" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="proffession" name="proffession" value="{{ $data->proffession }}" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="designation" name="designation" value="{{ $data->designation }}" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="linkedin_profile" name="linkedin_profile" value="{{ $data->linkedin_profile }}" class="form-control"
