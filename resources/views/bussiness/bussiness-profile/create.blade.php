                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="POST" action="{{ route('store-bussiness-profile') }}"
                                    ...
                                    <div class="col-lg-8 mx-auto">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="avg_monthly_sale" name="avg_monthly_sale"
                                                    class="form-control" placeholder="Enter avg_monthly_sale" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="latest_yearly_sale" name="latest_yearly_sale"
                                                    class="form-control" placeholder="Enter latest_yearly_sale" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="profit_margin_percentage"
                                                    name="profit_margin_percentage" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="expected_valuation" name="expected_valuation"
                                                    class="form-control" placeholder="Enter expected_valuation" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="real_valuation" name="real_valuation"
                                                    class="form-control" placeholder="Enter real_valuation" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="total_permanent_employee"
                                                    name="total_permanent_employee" class="form-control"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="established_date" name="established_date"
                                                    class="form-control" placeholder="Enter established_date" required>
